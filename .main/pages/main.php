...
<div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
            ...
            <!-- Project Buttons -->
            <?php
            if ($_SERVER["HTTP_HOST"] != $server_public) {
                print("<div class='mt-10 flex items-center justify-center gap-x-6'>
          <a href='$carsNum_main' target='_blank' class='rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
            Plate Number</a>
          ...
          <a href='$dateme_main' target='_blank' class='rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
            ...
            Notes App</a>
            <a href='{$twin}' target='_blank' class='rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
            ❤️‍🔥</a>
        </div>");
            }
            ?>
