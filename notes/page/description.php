...
<div>
    ...
    <button style='margin-top:5%;margin-left:80%' align='right' class="inline-flex px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">
