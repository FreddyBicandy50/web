...
<div class="flex-col py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-600">Sign in to your account</h2>
    </div>

    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="<?php echo $notes_router['REST'][0]?>" method="POST">
            <div>
            ...
            <div>
                ...
                <?php
                if (!$_SESSION['found']) echo "<p style='color:#ca1629'> Invalid Username or Password</p>";
                ?>
            </div>
        </form>
