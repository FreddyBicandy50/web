...
<div class="flex-col py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="<?php echo $main ? $notes_router['REST'][0] : $notes_router['REST'][1] ?>"
              method="POST">
            <?= !$main ?
                '<div>
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            ...
            ?>
            <a href="<?php echo $link == 'Register here' ? $notes_router['register'] : $notes_router['sign_in']; ?>"
               class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"><?= $link ?></a>
        </p>
    </div>
</div>