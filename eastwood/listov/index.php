...
<body>
  ...
  <div style="text-align: center;
        ">
    <button class="button" onclick="toggleCreditsMenu()" style="background-color: #BFBFBF;
                  position: fixed;
                  right:10px;
                  bottom:12px;">CREDITS</button>
  </div>
  <div id="creditsMenu" style="background-color: #B7B7B7;
                  border: none;
                  border-radius: 10px;
                  display: none; 
                  position: fixed;
                  ...
                  bottom: 33%;
                  ">
    <button class="button" onclick="toggleCreditsMenu()" style="font-family: verdana;
          font-size: 40px;
          text-align: Center;
          border: none;
          border-radius: 50px;
  ...
  <section style="background-color: #a8c8f0;
    ...
    border-radius:10px 10px 10px 10px;
      ...
      <button style="
          ...
          text-align: center;
          font-weight: bold;">
        <a href="#introduction" ; style="color: #000;
      ...
      <button style="
            ...
            text-align: center;
            font-weight: bold;">
        <a href="#context" ; style="color: #000;
                text-decoration: none;
                 ">
          2. CONTEXT
      </button>
      ...
      <button style="
            ...
            text-align: center;
            font-weight: bold;">
        <a href="#discovery" ; style="color: #000;
                    text-decoration: none;
                     ">
          3. DISCOVERY
      </button>
      ...
      <button style="
            ...
            text-align: center;
            font-weight: bold;">
        <a href="#influence" ; style="color: #000;
                    text-decoration: none;
                     ">
          4. INFLUENCE
      </button>
      ...
      <button style="
            ...
            text-align: center;
            font-weight: bold;">
        <a href="#effects" ; style="color: #000;
                    text-decoration: none;
                     ">
          5. EFFECTS
      </button>
      ...
      <button style="
            ...
            text-align: center;
            font-weight: bold;">
        <a href="#conclusion" ; style="color: #000;
                    text-decoration: none;
                     ">
          6. CONCLUSION
        </a>
      ...
      <button style="
          ...
          text-align: center;
          font-weight: bold;">
        <a href="#citations" ; style="color: #000;
                text-decoration: none;
                 ">
          7. CITATIONS
      </button>
  ...
  <section id="imagine" ; style="color: #000">
    <img src="https://t3.ftcdn.net/jpg/00/60/04/08/360_F_60040805_v44hUlIYziuW0jHXhyFASqI71ONkxGJi.jpg" style="float: right;
            width: 57%;
            height: 135px;
            border: none;
            border-radius: 50px">
  ...
  <section id="introduction" ; style="
                  ...
                  border-width: 10px;
                  ">
    <img src="https://group.met.com/media/tknc3bvb/importance-of-electricity.jpg?anchor=center&mode=crop&width=1920&rnd=133559252303130000&mode=max&upscale=false" style="float: right;
            width: 200px;
            height: 675px;
            border: none;
