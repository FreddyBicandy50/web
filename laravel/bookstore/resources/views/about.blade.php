<x-layout>
    <x-slot:page_title>About</x-slot:page_title>
    <x-slot:heading>About</x-slot:heading>
    <div data-aos="fade-up " class="text-gray-500 text-base text-xl"><b>What is Lorem Ipsum?</b></div>
    <div data-aos="fade-up" class="text-gray-500 text-base text-s">
    ...
    <div data-aos="fade-up" class="text-gray-500 text-base text-xl"><b>Why do we use it?</b></div>

    <div data-aos="fade-up" class="text-gray-500 text-base text-sm"> It is a long established fact that a reader will
    ...
    <div data-aos="fade-up" class="text-gray-500 text-base text-xl"><b> Where does it come from?</b></div>
    <div data-aos="fade-up" class="text-gray-500 text-base text-sm"> Contrary to popular belief, Lorem Ipsum is not
    ...
    <div data-aos="fade-up" class="text-gray-500 text-base text-xl"><b> Where does it come from?</b></div>
    <div data-aos="fade-up" class="text-gray-500 text-base text-sm"> The standard chunk of Lorem Ipsum used since the
    ...
    <div data-aos="fade-up" class="text-gray-500 text-base text-xl"><b> Where can I get some?</b></div>
    <div data-aos="fade-up" class="text-gray-500 text-base text-sm">
