...
<div class="dropdown">
  ...
  <a href="" onclick="myFunction()" style="margin-left:20px;color:#7a7df3 " class="font-bold tracking-tight text-gray-500 sm:text-3xl">
    ...
    #Web Hosting      
      ...
      print(
        "<div id='myDropdown' class='dropdown-content'>
              <a href='http://$SERVER_Testing' style='color:#10B981 ' class='font-bold tracking-tight text-gray-500 sm:text-2xl'>VPN Host</a>
              <a href='http://$SERVER_Production' style='color:#F87171 ' class='font-bold tracking-tight text-gray-500 sm:text-2xl'>localhost</a>
        </div>");
    }
    ?>
  </a>
